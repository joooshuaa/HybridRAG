...
LIGHTRAG_LLM_NAME = "Qwen/Qwen3-30B-A3B-Instruct-2507-FP8" #'qwen3:30b-a3b-instruct-2507-q8_0' #'gemma3:4b-it-qat' #'qwen3:0.6b' #'gemma3:12b-it-q4_K_M'
#LIGHTRAG_BASE_URL = "http://localhost:9621"
LIGHTRAG_LLM_MAX_TOKEN_SIZE = 65536 #131072 # 32768
LIGHTRAG_MAX_PARALLEL_INSERT = 2
LIGHTRAG_EMBEDDING_MODEL_NAME = "BAAI/bge-m3" #'bge-m3:latest' #"nomic-embed-text:latest"
